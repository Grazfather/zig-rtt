...
pub const DownChannel = extern struct {
    ...
    pub const Reader = std.io.GenericReader(*DownChannel, ReadError, readAvailable);
    ...
    pub fn readAvailable(self: *DownChannel, bytes: []u8) ReadError!usize {
    ...
    pub fn bytesAvailable(self: *DownChannel) usize {
